...
const Cell = React.memo(React.forwardRef(({ column, columnIndex, datum, isColumnVisible, isDragging, isLastRow, rowIndex, }, ref) => {
    const classNames = React.useContext(ClassNamesContext);
    ...
    return (React.createElement("div", { className: classnames(styles$3.Cell, {
...
const Row = React.memo(({ cellRefs, columns, columnVisibility, datum, draggingKey, isLastRow, isSelected, onClick, rowIndex, rowOverlay, }) => {
...
const GridWrapped = React.forwardRef(({ columns: rawColumns, data, defaultColumnMinWidth = 200, gridRef, onColumnsOrderChange, onColumnWidthChange, onRowClick, rowKey, rowOverlay, selectedRowIndexes, virtualizationEnabled, }, externalRef) => {
...
const Grid = React.memo(React.forwardRef((props, externalRef) => {
    ...
    return (React.createElement(ClassNamesContext.Provider, { value: props.classNames || {} },
        React.createElement(GridNodeContext.Provider, { value: gridRef.current },
