import React__default, { createContext, useRef, useState, useEffect, useCallback, createElement, Fragment, useContext, useMemo, cloneElement, Component, memo, forwardRef } from 'react';
...
const HeaderCellWrapped = ({ column: { key, width, label, minWidth, name, notResizable }, dragHandleProps, draggableInnerRef, draggableProps, draggingKey, headerCellRefs, isLastChild, onWidthChange, onWidthChangeEnd, style, transform, }) => {
    ...
    return (createElement(HeaderCellContainer, Object.assign({ isDragging: key === draggingKey, isAnyDragging: isAnyDragging, notResizable: notResizable, ref: (node) => {
        ...
        createElement(LabelContainer, null,
            createElement(Label, null, displayLabel)),
...
function Header({ columns: rawColumns, defaultColumnMinWidth, draggingKey, headerCellRefs, isColumnDragDisabled, onColumnWidthChange, trackingCellRefs, }) {
    ...
    return (createElement(Fragment, null,
        createElement("div", { className: classnames(styles$1.Header, {
...
const Cell = memo(forwardRef(({ cellComponent, column, columnIndex, datum, isColumnVisible, isDragging, isLastRow, rowIndex, }, ref) => {
    ...
    const children = createElement("div", { className: styles$2.Content }, value);
    if (cellComponent) {
        return createElement(Fragment, null, cellComponent({ children, className, style }));
    }
    return (createElement("div", { className: className, ref: ref, style: style }, children));
}));
...
function RowOverlay({ children, columnsLength, isHoveringRow, rowIndex, }) {
    ...
    return (createElement("div", { className: styles$3.RowOverlay, ref: ref, style: {
...
const Row = memo(({ cellComponent, cellRefs, columns, columnVisibility, datum, draggingKey, isLastRow, isSelected, onClick, rowIndex, rowOverlay, }) => {
    ...
    return (createElement("div", Object.assign({}, hoverBind, { className: classnames(styles$4.Row, {
        ...
        columns.map((column, columnIndex) => {
            const { key } = column;
            return (createElement(Cell, { cellComponent: cellComponent, column: column, datum: datum, isColumnVisible: Boolean(!columnVisibility || columnVisibility[columnIndex]), isDragging: key === draggingKey, isLastRow: isLastRow, key: key, ref: (node) => {
...
const GridWrapped = forwardRef(({ cellComponent, columns: rawColumns, data, defaultColumnMinWidth = 200, gridRef, onColumnsOrderChange, onColumnWidthChange, onRowClick, rowKey, rowOverlay, selectedRowIndexes, virtualizationEnabled, }, externalRef) => {
    ...
    return (createElement("div", { className: styles$5.GridPane },
        createElement(DragDropContext, { onDragEnd: onDragEnd, onDragUpdate: onDragUpdate, onDragStart: onDragStart },
            createElement(Droppable, { droppableId: "droppable", direction: "horizontal" }, ({ innerRef: droppableInnerRef, droppableProps }) => (createElement("div", Object.assign({ className: classnames(styles$5.Grid, {
